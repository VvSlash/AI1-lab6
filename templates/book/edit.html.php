...
$title = "Edit Book " . htmlspecialchars($book->getTitle()) . " ({$book->getId()})";
$bodyClass = "edit";

ob_start(); ?>
    <h1><?= $title ?></h1>
    <form action="<?= $router->generatePath('book-edit') ?>" method="post" class="edit-form" enctype="multipart/form-data">
